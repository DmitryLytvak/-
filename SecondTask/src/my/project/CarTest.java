...
public class CarTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Static:" + clientFirstCar.STATIC_NUMBER + ","
                + clientSecondCar.STATIC_NUMBER + ","
                + clientThirdCar.STATIC_NUMBER + ","
                + Car.STATIC_NUMBER);

        Car.STATIC_NUMBER = Car.STATIC_NUMBER + 1;

        System.out.println("Static:" + clientFirstCar.STATIC_NUMBER + "," + clientSecondCar.STATIC_NUMBER + ","
                + clientThirdCar.STATIC_NUMBER + "," + Car.STATIC_NUMBER);
